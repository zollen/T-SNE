...
public class EJMLVsPython {
	...
	public void testSum() {
		...
		System.out.println("TSne.sum(X) = " + CommonOps_DDRM.elementSum(X));
		assertEquals(172.0,CommonOps_DDRM.elementSum(X), epsilon);
	}
	...
	public void testMSum() {
		...
		double [][] sum0 = EjmlOps.extractDoubleArray(CommonOps_DDRM.sumCols(X,sumC));
		...
		double [][] sum1 = EjmlOps.extractDoubleArray(CommonOps_DDRM.sumRows(X,sumR));
	...
	public void testSquare() {
		...
		CommonOps_DDRM.elementPower(X,2,sq);
	...
	public void testTimes() {
		...
		CommonOps_DDRM.transpose(X,tr);
		CommonOps_DDRM.mult(X,tr,mult);
	...
	public void testScalarInverseVector() {
		...
		DMatrixRMaj row = CommonOps_DDRM.extract(X,3,4,0,5);
		CommonOps_DDRM.divide(1.0, row);
	...
	public void testScalarMultiply() {
		...
		CommonOps_DDRM.elementMult(X,X);
	...
	public void testMinus() {
		...
		CommonOps_DDRM.subtract(X, X, mins);
	...
	public void testAssignCol() {
		...
		CommonOps_DDRM.insert(sumR,X,3,0);
		assertEqualDoubleArrays(pyasgn, EjmlOps.extractDoubleArray(X), epsilon);
	}
